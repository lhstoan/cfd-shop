							...
							<aside className="col-md-4 col-lg-3">
								<ul className="nav nav-dashboard flex-column mb-3 mb-md-0" role="tablist">
									<li className="nav-item">
										<a className="nav-link active" id="tab-account-link" data-toggle="tab" href="#tab-account" role="tab" aria-controls="tab-account" aria-selected="false">Account Details</a>
									</li>
									<li className="nav-item">
									...
									<li className="nav-item">
										<a className="nav-link" id="tab-wishlist-link" data-toggle="tab" href="#tab-wishlist" role="tab" aria-controls="tab-wishlist" aria-selected="false">Wishlist</a>
									</li>
									<li className="nav-item">
										...
										<form action="#" className="account-form">
											<div className="row">
												...
												<div className="col-sm-6">
													...
													<input type="email" className="form-control" defaultValue="trannghia@gmail.com" disabled required />
												</div>
											</div>
											<div className="row">
												<div className="col-sm-6">
											...
											<div className="row">
												<div className="col-sm-4">
													...
													<div className="select-custom">
														<select className="form-control form-select" id="city" aria-label="Default select example">
															<option selected />
														</select>
													</div>
												</div>
											...
											<input type="email" className="form-control" defaultValue="30 Ba Thang Hai St." required />
												...
												<div className="card card-dashboard">
													<div className="card-body">
														...
														<p>
															...
															<br />
															<a href="#">Edit <i className="icon-edit" />
															</a>
														</p>
													</div>
												</div>
											...
											<div className="col-lg-6">
												<div className="card card-dashboard">
													<div className="card-body">
														...
														<p>Cecilia Chapman 711-2880 Nulla St. Mankato Mississippi <br />
															<br />
															<a href="#">Edit <i className="icon-edit" />
															</a>
														</p>
