								...
								<div className="entry-item col-sm-6">
									<article className="entry entry-grid">
										...
										<div className="entry-body">
											...
											<h2 className="entry-title">
												<a href="blog-single.html">Vivamus vestibulum ntulla necante.</a>
											</h2>
											<div className="entry-content">
								...
								<div className="entry-item col-sm-6">
									<article className="entry entry-grid">
										...
										<div className="entry-body">
											...
											<h2 className="entry-title">
												<a href="blog-single.html">Aenean dignissim pellente squefelis.</a>
											</h2>
											<div className="entry-content">
								...
								<div className="entry-item col-sm-6">
									<article className="entry entry-grid">
										...
										<div className="entry-body">
											...
											<h2 className="entry-title">
												<a href="blog-single.html">Quisque volutpat mattiseros.</a>
											</h2>
											<div className="entry-content">
